...
# Test script for LIQE with URL
# This script helps test the Java code with the provided URL
...
echo "=========================================="
echo "LIQE Test with URLs (Batch)"
echo "=========================================="
echo ""
...
if [ ! -f "$CLIP_MODEL" ]; then
    ...
    echo "  # OR from java_codes directory:"
    echo "  python scripts/liqe_torch2onnx.py --output_dir weights/onnx"
    exit 1
fi
